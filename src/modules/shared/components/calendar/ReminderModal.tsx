      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-3">
          ...
          >
            <Label
              htmlFor="email"
              className={`flex flex-col items-center gap-2 p-4 rounded-lg border cursor-pointer transition-colors ${reminderType === 'email'
            ...
            <Label
              htmlFor="push"
              className={`flex flex-col items-center gap-2 p-4 rounded-lg border cursor-pointer transition-colors ${reminderType === 'push'
                  ? 'border-primary bg-primary/5'
                  : 'border-border hover:bg-muted/50'
                }`}
            >
            ...
            <Label
              htmlFor="sms"
              className={`flex flex-col items-center gap-2 p-4 rounded-lg border cursor-pointer transition-colors ${reminderType === 'sms'
                  ? 'border-primary bg-primary/5'
                  : 'border-border hover:bg-muted/50'
                }`}
            >
